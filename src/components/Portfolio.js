...
const Portfolio = () => {
  ...
  return (
    ...
    '>
      ...
      flex-col justify-center w-full h-auto xs:mt-20 mt-10 pt-20 md:h-screen'>
                ...
                >       
                  ...
                  '>
                    <a
                      ...
                      <div
                          className='xs:px-8 px-12 xs:m-5 m-8 md:my-4 md:px-10 flex justify-center duration-300 hover:scale-110' 
                      >               
                        {text}    
                      </div>
                    </a>
